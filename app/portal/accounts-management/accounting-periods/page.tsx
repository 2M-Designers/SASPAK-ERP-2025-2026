...
export default async function HomePage() {
  ...
  const requestBody: GetListRequest = {
    select:
      "AccountingPeriodId,FiscalYearId,PeriodName,StartDate,EndDate,Status,Version",
    where: "",
    sortOn: "AccountingPeriodId",
    page: "1",
    pageSize: "50", // Start with a reasonable page size
  };

  try {
    const response = await fetch(`${baseUrl}AccountingPeriod/GetList`, {
      method: "POST",
      headers: {
