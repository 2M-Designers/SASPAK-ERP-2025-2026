...
export default async function HomePage() {
  ...
  const requestBody: GetListRequest = {
    select:
      "UNAIRPortId,AirportCode,AirportName,UNLocationId,IsActive,Remarks,CreatedBy,CreatedAt,UpdatedAt,Version",
    where: "",
    sortOn: "AirportName",
    page: "1",
  ...
  try {
    const response = await fetch(`${baseUrl}Unairport/GetList`, {
      method: "POST",
      headers: {
    ...
    console.error("Failed to fetch UN Airports:", error);
