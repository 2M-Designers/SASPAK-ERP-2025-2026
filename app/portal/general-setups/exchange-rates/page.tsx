...
export default async function HomePage() {
  ...
  const requestBody: GetListRequest = {
    select:
      "ExchangeRateId,CompanyId,FromCurrencyId,ToCurrencyId,Rate,EffectiveDate,RateExpiryDate,IsActive,Version",
    where: "",
    sortOn: "",
    page: "1",
  ...
  try {
    const response = await fetch(`${baseUrl}SetupExchangeRate/GetList`, {
      method: "POST",
      headers: {
